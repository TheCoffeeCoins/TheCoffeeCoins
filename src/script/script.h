...
#ifndef thecoffeecoins_SCRIPT_SCRIPT_H
#define thecoffeecoins_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, thecoffeecoins always counted CHECKMULTISIGs
...
#endif // thecoffeecoins_SCRIPT_SCRIPT_H

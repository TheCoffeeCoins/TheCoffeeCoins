...
#ifndef thecoffeecoins_WALLET_WALLET_H
#define thecoffeecoins_WALLET_WALLET_H
...
public:
     ...
     * on this thecoffeecoins node, and set to 0 for transactions that were created
...
#endif // thecoffeecoins_WALLET_WALLET_H

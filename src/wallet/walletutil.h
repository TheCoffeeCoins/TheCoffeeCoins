...
#ifndef thecoffeecoins_WALLET_WALLETUTIL_H
#define thecoffeecoins_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! thecoffeecoins from opening the wallet, thinking it was newly created, and
...
#endif // thecoffeecoins_WALLET_WALLETUTIL_H

...
#ifndef thecoffeecoins_IPC_PROCESS_H
#define thecoffeecoins_IPC_PROCESS_H
...
//! IPC process interface for spawning thecoffeecoins processes and serving requests
...
#endif // thecoffeecoins_IPC_PROCESS_H

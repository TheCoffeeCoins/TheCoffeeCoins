...
#ifndef thecoffeecoins_NET_H
#define thecoffeecoins_NET_H
 ...
 * src/qt/guiutil.cpp and src/thecoffeecoins-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on thecoffeecoins’s Peer-to-Peer Network")

...
#ifndef thecoffeecoins_TEST_SCRIPTNUM10_H
#define thecoffeecoins_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from thecoffeecoins Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // thecoffeecoins_TEST_BIGNUM_H

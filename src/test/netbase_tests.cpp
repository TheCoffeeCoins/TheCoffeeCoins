...
{
    BOOST_CHECK(TestSplitHost("www.thecoffeecoinscore.org", "www.thecoffeecoinscore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.thecoffeecoinscore.org]", "www.thecoffeecoinscore.org", 0));
    BOOST_CHECK(TestSplitHost("www.thecoffeecoinscore.org:80", "www.thecoffeecoinscore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.thecoffeecoinscore.org]:80", "www.thecoffeecoinscore.org", 80));

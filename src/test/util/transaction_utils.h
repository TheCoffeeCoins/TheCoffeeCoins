...
#ifndef thecoffeecoins_TEST_UTIL_TRANSACTION_UTILS_H
#define thecoffeecoins_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // thecoffeecoins_TEST_UTIL_TRANSACTION_UTILS_H

...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, thecoffeecoinsGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &thecoffeecoinsGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &thecoffeecoinsGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &thecoffeecoinsGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &thecoffeecoinsGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &thecoffeecoinsGUI::updateWalletStatus);
    connect(gui, &thecoffeecoinsGUI::setPrivacy, walletView, &WalletView::setPrivacy);

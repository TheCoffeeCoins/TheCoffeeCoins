    ...
    platformStyle(_platformStyle)
{
    ...
    // normal thecoffeecoins address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying thecoffeecoins address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &thecoffeecoinsAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);

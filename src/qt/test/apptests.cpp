...
//! Entry point for thecoffeecoinsApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &thecoffeecoinsApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for thecoffeecoinsGUI tests.
void AppTests::guiTests(thecoffeecoinsGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &thecoffeecoinsGUI::consoleShown, this, &AppTests::consoleTests);

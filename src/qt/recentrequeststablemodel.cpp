    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return thecoffeecoinsUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, thecoffeecoinsUnits::SeparatorStyle::NEVER);
            else
                return thecoffeecoinsUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+thecoffeecoinsUnits::shortName(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}

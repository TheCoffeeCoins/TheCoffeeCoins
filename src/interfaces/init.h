...
#ifndef thecoffeecoins_INTERFACES_INIT_H
#define thecoffeecoins_INTERFACES_INIT_H
...
//! (thecoffeecoins-gui, thecoffeecoins-node, thecoffeecoins-wallet, thecoffeecoinsd, thecoffeecoins-qt) and each
...
#endif // thecoffeecoins_INTERFACES_INIT_H

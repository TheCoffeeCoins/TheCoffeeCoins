...
#ifndef thecoffeecoins_RPC_PROTOCOL_H
#define thecoffeecoins_RPC_PROTOCOL_H
...
//! thecoffeecoins RPC error codes
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in thecoffeecoinsd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< thecoffeecoins is not connected
...
#endif // thecoffeecoins_RPC_PROTOCOL_H

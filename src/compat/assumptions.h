...
#ifndef thecoffeecoins_COMPAT_ASSUMPTIONS_H
#define thecoffeecoins_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "thecoffeecoins cannot be compiled without assertions."
#endif
...
#endif // thecoffeecoins_COMPAT_ASSUMPTIONS_H

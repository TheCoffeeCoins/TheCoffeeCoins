...
#ifndef thecoffeecoins_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define thecoffeecoins_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // thecoffeecoins_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H

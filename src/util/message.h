...
#ifndef thecoffeecoins_UTIL_MESSAGE_H
#define thecoffeecoins_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's thecoffeecoins address, it must refer to a public key.
...
#endif // thecoffeecoins_UTIL_MESSAGE_H

...
This document provides guidelines for internationalization of the thecoffeecoins Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `thecoffeecoins_en.ts` remains unchanged.

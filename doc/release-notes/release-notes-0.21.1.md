...
thecoffeecoins Core version 0.21.1 is now available from:

  <https://thecoffeecoinscore.org/bin/thecoffeecoins-core-0.21.1/>
...
fungibility of all thecoffeecoinss. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to thecoffeecoins Core's wallet is
...
FAQ](https://thecoffeecoinscore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/thecoffeecoins/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/thecoffeecoins/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/thecoffeecoins/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit thecoffeecoins](https://thecoffeecoinsmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-thecoffeecoins)
  - [What do Schnorr Signatures Mean for thecoffeecoins?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-thecoffeecoins)
...
- Development history overview
  - [Taproot](https://thecoffeecoinsops.org/en/topics/taproot/)
  - [Schnorr signatures](https://thecoffeecoinsops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://thecoffeecoinsops.org/en/topics/tapscript/)
  - [Soft fork activation](https://thecoffeecoinsops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://thecoffeecoins.stackexchange.com/questions/tagged/taproot)
  - [Taproot review](https://github.com/ajtowns/taproot-review)

Updated RPCs
------------

- Due to [BIP 350](https://github.com/thecoffeecoins/bips/blob/master/bip-0350.mediawiki)
  being implemented, behavior for all RPCs that accept addresses is changed when
  a native witness version 1 (or higher) is passed. These now require a Bech32m
  encoding instead of a Bech32 one, and Bech32m encoding will be used for such
  addresses in RPC output as well. No version 1 addresses should be created
  for mainnet until consensus rules are adopted that give them meaning
  (e.g. through [BIP 341](https://github.com/thecoffeecoins/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to thecoffeecoins.conf documentation (jonatack)

...
thecoffeecoins Core version 0.19.1 is now available from:

  <https://thecoffeecoinscore.org/bin/thecoffeecoins-core-0.19.1/>
...
From thecoffeecoins Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as thecoffeecoins Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, thecoffeecoins Core does not yet change appearance when
...
- #17488 fix "thecoffeecoinsd already running" warnings on macOS (fanquake)

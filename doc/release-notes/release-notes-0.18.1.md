thecoffeecoins Core version 0.18.1 is now available from:

  <https://thecoffeecoinscore.org/bin/thecoffeecoins-core-0.18.1/>
...
`/Applications/thecoffeecoins-Qt` (on Mac) or `thecoffeecoinsd`/`thecoffeecoins-qt` (on
Linux).
...
recommended to use thecoffeecoins Core on unsupported systems.
...
- #15947 Install thecoffeecoins-wallet manpage (domob1812)

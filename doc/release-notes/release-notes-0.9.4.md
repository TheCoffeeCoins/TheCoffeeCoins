thecoffeecoins Core version 0.9.4 is now available from:

  https://thecoffeecoins.org/bin/0.9.4/
...
this update is incompatible with the thecoffeecoins system and could lead to consensus
forks.

thecoffeecoins Core released binaries from https://thecoffeecoins.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~thecoffeecoins/+archive/ubuntu/thecoffeecoins
- A third-party or self-compiled thecoffeecoins Core

upgrade to thecoffeecoins Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

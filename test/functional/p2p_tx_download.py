...
class TxDownloadTest(thecoffeecoinsTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new thecoffeecoinsd instances, as setting mocktimes has long-term effects on when

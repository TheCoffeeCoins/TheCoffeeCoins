...
"""Verify that starting thecoffeecoins with -h works as expected."""

from test_framework.test_framework import thecoffeecoinsTestFramework
from test_framework.util import assert_equal

class HelpTest(thecoffeecoinsTestFramework):
    ...
    def run_test(self):
        self.log.info("Start thecoffeecoins with -h for help text")
        ...
        self.log.info("Start thecoffeecoins with -version for version information")
        ...
        self.log.info("Start thecoffeecoinsd with -fakearg to make sure it does not start")

...
By default, thecoffeecoinsd will dump mempool on shutdown and
...
class MempoolPersistTest(thecoffeecoinsTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent thecoffeecoinsd from writing mempool.dat to disk. Verify that `savemempool` fails")

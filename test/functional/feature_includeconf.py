#!/usr/bin/env python3
# Copyright (c) 2018-2019 The thecoffeecoins Core developers
...
class IncludeConfTest(thecoffeecoinsTestFramework):
    ...
    def setup_chain(self):
        ...
        with open(os.path.join(self.options.tmpdir, "node0", "thecoffeecoins.conf"), "a", encoding='utf8') as f:

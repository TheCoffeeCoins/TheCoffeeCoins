...
class P2PPermissionsTests(thecoffeecoinsTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].thecoffeecoinsconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].thecoffeecoinsconf, 'w', encoding="utf8") as f:
            f.write(newText)

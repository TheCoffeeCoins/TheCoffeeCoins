...
class TestShell:
    """Wrapper Class for thecoffeecoinsTestFramework.

    The TestShell class extends the thecoffeecoinsTestFramework
    ...
    class __TestShell(thecoffeecoinsTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by thecoffeecoinsTestFramework child class.
            self.num_nodes = 1
